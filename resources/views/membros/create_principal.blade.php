<div class="x_panel modal-content" >
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="col-md-2 col-xs-offset-1">
               <img src="/uploads/avatars/{{ Auth::user()->avatar }}" style="width:100px; position:absolute; height: 100px; float: right; border-radius: 50%; margin-right: 25px; ">
            </div>
         </div>
      </div>
   ...
   <div class="item form-group">
      ...
      <div  class="col-md-2" >
         <input  id="co_cim" class="form-control col-md-2 cim" name="co_cim" placeholder="1234567" required="required" 
            type="number" min="1" max="9999999" data-inputmask="'mask' : '9.999.999', 'numericInput': 'true' " type="text" 
            value="{{$membro->co_cim or old('co_cim')}}" >
      </div>

      <label class="control-label col-md-1 " for="dt_nascimento">Nascim.*</label>
      <div class="col-md-2 ">
         <input id="dt_nascimento" class="form-control col-md-2 datas_input" name="dt_nascimento" placeholder="Data de Nascimento" 
            type="date" value="{{$membro->dt_nascimento or old('dt_nascimento')}}" >
      </div>
   ...
   <div class="item form-group">
      ...
      <div class="col-md-3">
         <input id="dt_casamento" class="form-control col-md-2 datas_input" name="dt_casamento" placeholder="Data de Casamento" disabled type="date" value="{{$membro->dt_casamento or old('dt_casamento')}}" >
      </div>
   </div>
