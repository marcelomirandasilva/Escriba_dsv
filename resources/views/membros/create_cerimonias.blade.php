<div class="x_panel modal-content" >
   ...
   <div class="item form-group">
      ...
      <div class="col-md-2 ">
         <input id="dt_cerimonia0" name="cerimonias[0][dt_cerimonia]" class="form-control col-md-2 datas_input"  type="date" 
   ...
   <div class="item form-group">
      ...
      <div class="col-md-2 ">
         <input id="dt_cerimonia1" name="cerimonias[1][dt_cerimonia]" class="form-control col-md-2 datas_input"  type="date" 
   ...
   <div class="item form-group">
      ...
      <div class="col-md-2 ">
         <input id="dt_cerimonia2" name="cerimonias[2][dt_cerimonia]" class="form-control col-md-2 datas_input"  type="date" 
   ...
   <div class="item form-group">
      ...
      <div class="col-md-2 ">
         <input id="dt_cerimonia3" name="cerimonias[3][dt_cerimonia]" class="form-control col-md-2 datas_input"  type="date" 
   ...
   <div class="item form-group">
      ...
      <div class="col-md-2 ">
         <input id="dt_cerimonia4" name="cerimonias[4][dt_cerimonia]" class="form-control col-md-2 datas_input"  type="date" 
      ...
      <div class="col-md-2 ">
         <input id="dt_cerimonia5" name="cerimonias[5][dt_cerimonia]" class="form-control col-md-2 datas_input"  type="date" 
